...
def Runexp5(test_dataset_path, results_dir, model_dir, csv_filename, image_base_dir):
    """
    ...
    for index, row in test_data.iterrows():
        task_name = row["task"]
        query = QUERIES.get(task_name, None)  # Retrieve the query for the task
        print("Unique tasks in test_data:", test_data["task"].unique())
        print("QUERIES keys:", QUERIES.keys())
