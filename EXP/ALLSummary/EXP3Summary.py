...
def process_and_plot_multiplerun():
    """Process three EXP3 result files and create averaged plot"""
    # Define file paths
    file_paths = [
        "/hpcstor6/scratch01/h/huuthanhvy.nguyen001/EXP3/finetuning-EXP3numberone/EXP-Results/EXP3results10images.csv",
        "/hpcstor6/scratch01/h/huuthanhvy.nguyen001/EXP3/finetuning-EXP3numbertwo/EXP-Results/EXP3results10images.csv",
        "/hpcstor6/scratch01/h/huuthanhvy.nguyen001/EXP3/finetuning-EXP3numberthree/EXP-Results/EXP3results10images.csv"
    ]
    ...
    for i, file_path in enumerate(file_paths, 1):
        ...
        # Calculate metrics
        metrics = calculate_metrics(df_type1, df_type2, df_type3, df_type4, df_type5)
