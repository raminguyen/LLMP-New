...
def process_and_plot_multiplerun():
    ...
    # Define file paths
    file_paths = [
        "/hpcstor6/scratch01/h/huuthanhvy.nguyen001/EXP4/finetuning-EXP4numberone/EXP-Results/EXP4results10images.csv",
        "/hpcstor6/scratch01/h/huuthanhvy.nguyen001/EXP4/finetuning-EXP4numbertwo/EXP-Results/EXP4results10images.csv",
        "/hpcstor6/scratch01/h/huuthanhvy.nguyen001/EXP4/finetuning-EXP4numberthree/EXP-Results/EXP4results10images.csv"
    ]
...
def checkdeletedrows_forallcsv():
    ...
    for file_path in file_paths:
        ...
        metrics_table
        #process_plot(metrics_table)

        deleted_df = pd.DataFrame(deleted_rows)
        deleted_df['file'] = file_path.split('/')[-1]  # Add filename for reference
